...
img_dir = '/Users/srivatsavkannan/Datasets/C-Spine Xray/X-ray Atlas/Train-Test-Split/Train_ROS'
...
img_dir = '/Users/srivatsavkannan/Datasets/C-Spine Xray/X-ray Atlas/Train-Test-Split/Test_ROS'
...
for batch in val_combined:
    images, labels = batch
    actual_bboxes = labels["bounding_box"].numpy()
    actual_labels = labels["classification"].numpy()
