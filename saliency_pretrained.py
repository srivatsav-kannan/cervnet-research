...
img_path = '/Users/srivatsavkannan/Datasets/CervicalNew10/ValROSCroppedCLAHE/CS'
img_size = (600, 600)
...
# model = tf.keras.models.load_model('cs4.keras')
# input_image = cv2.imread('documenting/cs1/test1.jpg')
...
model_builder = tf.keras.applications.EfficientNetB7
