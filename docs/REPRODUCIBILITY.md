...
For each experiment promoted from `prototypes/`:
...
Prototype scripts should be treated as source material during this migration,
not invoked as an automated pipeline without review.
