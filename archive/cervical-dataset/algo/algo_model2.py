...
def read_json_file(json_path):
    ...
    img_dir = '/Users/srivatsavkannan/Datasets/FinalCervicalDataset/All/'+pic_id+'.png'
    oimg_dir = '/Users/srivatsavkannan/Datasets/C-Spine Xray/X-ray Atlas/datasets-PNG/'+pic_id+'.png'
    img = Image.open(img_dir).convert("RGB")
    oimg = Image.open(oimg_dir).convert("RGB")
    ...
    results = results[0]
    results = np.reshape(results, (23, 2))
    original_width, original_height = oimg.size
    ...
    results = results/224.0
    results[:, 0] = results[:, 0] * original_width
    results[:, 1] = results[:, 1] * original_height
...
#     print(position)
#     json_folder_path = '/Users/srivatsavkannan/Datasets/C-Spine Xray/X-ray Atlas/datasets-JSON'  # 您的JSON文件夹路径
#     output_excel_path = '/Users/srivatsavkannan/Datasets/C-Spine Xray/X-ray Atlas/results.xlsx'   # 您想要保存结果的Excel文件路径
#     cal_json_folder(json_folder_path, output_excel_path)

# 主程序入口
if __name__ == '__main__':
    json_folder_path = '/Users/srivatsavkannan/Datasets/C-Spine Xray/X-ray Atlas/datasets-JSON'  # 您的JSON文件夹路径
    output_excel_path = '/Users/srivatsavkannan/Datasets/FinalCervicalDataset/results3.xlsx'  # 您想要保存结果的Excel文件路径
    cal_json_folder(json_folder_path, output_excel_path)