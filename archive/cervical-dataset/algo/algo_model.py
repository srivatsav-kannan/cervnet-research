...
def read_json_file(json_path):
    ...
    img_dir = '/Users/srivatsavkannan/Datasets/CompressedCervicalDataset/All/'+pic_id+'.png'
...
if __name__ == '__main__':
    json_folder_path = '/Users/srivatsavkannan/Datasets/C-Spine Xray/X-ray Atlas/datasets-JSON'  # 您的JSON文件夹路径
    output_excel_path = '/Users/srivatsavkannan/Datasets/CompressedCervicalDataset/results.xlsx'  # 您想要保存结果的Excel文件路径
    cal_json_folder(json_folder_path, output_excel_path)