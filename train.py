...
train_dir = "/Users/srivatsavkannan/Datasets/CervicalNew2Recreate/TrainROSCroppedAugNormalizedCLAHE"
val_dir = "/Users/srivatsavkannan/Datasets/CervicalNew2Recreate/ValROSCroppedCLAHE"
...
# x = tf.keras.layers.BatchNormalization()(x)  # Optional: Helps with training stability
# x = tf.keras.layers.MaxPooling2D(pool_size=(2, 2))(x)  # Optional: Reduces spatial dimensions
...
model.save('cs6.keras')
y_true = []
y_pred = []

for images, labels in val_ds:
    a = np.argmax(model.predict(images), axis=1)
    print(labels.numpy())
    print(a)
...
model = tf.keras.models.load_model('cs6.keras')
...
#
# # # Save the model
joblib.dump(svm_classifier, 'documenting/cs6/svm6.pkl')
